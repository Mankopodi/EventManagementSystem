            ...
            <div className="flex flex-col justify-start items-start w-full space-y-8">
                ...
                <div className="w-full flex justify-start items-start flex-col bg-gray-50 p-8">
                    ...
                    <div className={"md:block " + (menu ? "block" : "hidden")}>
                        <p className="mt-3 text-base leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">It was the first night of a workshop entitled “Empowerment Dialogue & Gestalt Dreamwork” I learned so much in 4 hours, but what I really enjoyed was feeling welcomed by a bunch of strangers.
