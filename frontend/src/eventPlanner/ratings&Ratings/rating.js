        ...
        <div className="w-full flex justify-start items-start flex-col bg-gray-50 p-8">
          ...
          <div className={"md:block " + (menu ? "block" : "hidden")}>
            <p className="mt-3 text-base leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">
              It was the first night of a workshop entitled “Empowerment
              Dialogue & Gestalt Dreamwork” I learned so much in 4 hours, but
              what I really enjoyed was feeling welcomed by a bunch of
              strangers.
            </p>
          ...
          <div className="w-full flex justify-start items-start flex-col bg-gray-50 md:px-8 py-8">
            ...
            <div className={"md:block " + (menu1 ? "block" : "hidden")}>
              <p className="mt-3 text-base leading-normal text-gray-600 w-full md:w-9/12 xl:w-5/6">
                The wedding was so Beatiful, It was also a good chance to catch
                up with my old friends and we all had a great time. We
                definitely made the most of the occasion and took a lot of
                pictures with the bride and the bridegroom. I gave my friend a
                gift to celebrate her wedding day. I had given much thought to
                my wedding present when I was choosing it, and I wished her lots
                of happiness for the future.
              </p>
              <div className="mt-6 flex flex-row justify-start items-start space-x-4"></div>
              <div className="mt-6 flex justify-start items-center flex-row space-x-2.5">
                <div>
