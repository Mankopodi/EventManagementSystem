...
export default function Addpackage() {
  ...
  const onSubmit = async (e) => {
    ...
    await axios.post("http://localhost:1337/api/customize-events-packages", customizeEventsPackages);
...
//       }
//     }
//     await axios.create(`http://localhost:1337/api/customize-events-packages/${id}`, data,
